  ...
  return (
    <div className="w-full mx-auto relative bg-white">
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-3/4 aspect-[16/9]">
          <Link
        ...
        <button
          ...
          className="absolute right-4 md:right-[26%] top-1/2 transform -translate-y-1/2 bg-opacity-50 text-white p-4 rounded-full hover:bg-opacity-70 transition-all"
        ...
        <div className="block md:hidden">
          {locations.map((location, index) => (
            <Link
              key={index}
              to={location.path}
              className="relative block w-full mb-4 h-full"
            >
              <img
                src={location.image}
        ...
        <Link
          to={currentLocation.path}
          className="hidden md:block w-full md:w-1/4 aspect-[16/9] bg-[#fef880] text-[rgb(67,67,67)] transition-all duration-500"
        >
          <div className="flex flex-col h-full justify-center px-7 py-8 space-y-4">
            ...
            <div className="flex justify-start">
              <img className="w-32" src="/Pil.png" alt="Arrow"></img>
            </div>
          </div>
        </Link>
      </div>
